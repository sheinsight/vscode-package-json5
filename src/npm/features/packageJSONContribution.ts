...
import { Location } from "json5-parser";
import { MOST_DEPENDE_ON, KNOWN_SCOPES } from "vs-json5/@shared/constant";
...
export class PackageJSONContribution implements IJSONContribution {
  private mostDependedOn = MOST_DEPENDE_ON;

  private knownScopes = KNOWN_SCOPES;

  public getDocumentSelector(): DocumentSelector {
    return [{ language: "json5", scheme: "*", pattern: "**/package.json5" }];
  }
